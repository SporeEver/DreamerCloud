...
import { Sparkles, RefreshCw, Download, X, Palette, Wand2 } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Transform your dream into visual art</p>
          </div>
        </div>
        ...
        <div className="text-center py-8">
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-6 mb-4">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Generate a unique artistic interpretation of your dream using AI
            </p>
            <button
              onClick={onGenerate}
      ...
      {isGenerating && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm">
            AI is analyzing your dream and generating a unique artistic interpretation...
          </p>
